  ...
  return (
    <div className="bg-white/10 dark:bg-white/5 backdrop-blur-lg p-6 rounded-lg border border-gray-200/20 dark:border-white/10 hover:bg-white/20 dark:hover:bg-white/10 transition-all duration-300 shadow-lg">
      <div className="text-center">
        ...
        <h1 className="text-lg font-bold mt-2">Alwaysriky-DcoderX <RiVerifiedBadgeFill className="inline text-blue-500" /></h1>
        ...
        <div className="flex justify-center gap-2 mt-3">
          ...
          <span className="bg-white/5 px-3 py-1 rounded-full text-xs hover:bg-white/10 transition-all hover:scale-105 ring-1 ring-yellow-500">Free Fire</span>
        ...
        <div className="flex justify-center gap-4 mt-4 text-xl text-gray-400">
          <a href="https://instagram.com/mrizkirajditia" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-zinc-100 transition-colors">
            <FaInstagram className="h-5 w-5 text-pink-600" />
          </a>
          <a href="https://github.com/alwaysriky-DcoderX" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-zinc-100 transition-colors">
